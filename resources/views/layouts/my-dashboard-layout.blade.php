...
<html lang="en">
  <head>
    ...
    <link href={{ asset('dashboard/assets/css/plugins.min.css') }} rel="stylesheet"/>
    <link href={{ asset('dashboard/assets/css/kaiadmin.min.css') }} rel="stylesheet"/>
    ...
    <div class="wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="container" style="padding: 80px">
            <main role="main" class="main-content" style="padding: 15px">
                @yield('content')
            </main>
        </div>
        ...
        <footer class="footer">
          <div class="container-fluid d-flex justify-content-between">
             <nav class="pull-left">
              <ul class="nav">
                <li class="nav-item">
                  <a class="nav-link" href="http://www.System.com">
                  </a>
                </li>
              </ul>
            </nav>
            <div class="copyright">
              2026, Alejandro Ventura Fuentes <i class="fa fa-heart heart text-danger"></i> by
              <a href="http://www.System.com">System</a>
            </div>
          </div>
        </footer>
      </div>
